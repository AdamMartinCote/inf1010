...
public:
	...
	/**
	 * @brief trie les pouvoirs de la préature selon un prédicat binaire passé
	 * en argument
	 * @param pred
	 */
	template<class FuncType> void trierPouvoir(FuncType pred){
		sort(pouvoirs_.begin(), pouvoirs_.end(), pred);
	}
